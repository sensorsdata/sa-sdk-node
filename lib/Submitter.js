...
let Submitter = /*#__PURE__*/function (_Subject) {
  ...
  _createClass(Submitter, [{
    ...
    key: "submit",
    value: function () {
      var _submit = _asyncToGenerator(function* (messages) {
        ...
        const dataListBuffer = yield this.gzip ? _zlib.default.gzip(payloadText) : payloadText;
        ...
        debug("Body: %o", body);
        debug("Posting...");
        const response = yield (0, _nodeFetch.default)(this.url, {
          method: "POST",
          headers,
          body,
