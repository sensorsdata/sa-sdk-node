  ...
  _createClass(Submitter, [{
    ...
    value: (() => {
      var ref = _asyncToGenerator(function* (data) {
        ...
        try {
          yield this.submit(messages);
          debug('Submit succeeded');
          _get(Object.getPrototypeOf(Submitter.prototype), 'onNext', this).call(this, null);
        } catch (ex) {
    ...
    key: 'submit',
    value: (() => {
      var ref = _asyncToGenerator(function* (messages) {
