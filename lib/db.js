...
var DBCache = /*#__PURE__*/function () {
  ...
  _createClass(DBCache, [{
    ...
    key: "uploadCache",
    value: function () {
      var _uploadCache = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(upload) {
        var interval, unit, timer;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              interval = 2 * 1000;
              unit = 50;
              timer = setTimeout(function fetchAndUpload() {
                db.find({}).limit(unit).exec( /*#__PURE__*/function () {
                  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(err, events) {
                    var sendTasks;
