...
let SensorsAnalytics = function (_Subject) {
  ...
  _createClass(SensorsAnalytics, [{
    ...
    value: function superizeProperties() {
      ...
      return {
        properties: _ramda2.default.mergeAll([(0, _translators.snakenizeKeys)(SDK_PROPERTIES), this.superProperties, (0, _translators.translateUserAgent)(properties)]),
        lib: (0, _translators.snakenizeKeys)(_ramda2.default.mergeAll([SDK_PROPERTIES, codeProperties, { '$app_version': this.superProperties.$app_version }]))
      };
    }
  }, {
    key: 'track',
