...
function (_Subject) {
  ...
  function SensorsAnalytics() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(SensorsAnalytics).call(this));
    _this.logger = null;
    _this.loggingConsumer = false;

    _this.disableReNameOption();
  ...
  _createClass(SensorsAnalytics, [{
    ...
    value: function superizeProperties() {
      ...
      let callIndex = arguments.length > 1 ? arguments[1] : undefined;
      // 合并公共属性
    ...
    value: function internalTrack(type, _ref) {
      ...
      if (this.allowReNameOption) {
        ...
        properties = (0, _translators.snakenizeKeys)(properties); // eslint-disable-next-line no-param-reassign
