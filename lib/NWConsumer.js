...
function (_Subject) {
  ...
  function NWConsumer(_ref) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(NWConsumer).call(this));
    ...
    _this.dataQueue = new _TaskQueue.default({
      ...
      onSucceeded: () => {
        _get(_getPrototypeOf(NWConsumer.prototype), "onNext", _assertThisInitialized(_this)).call(_assertThisInitialized(_this), null);
      },
  ...
  _createClass(NWConsumer, [{
    ...
    key: "pushCache",
    value: async function pushCache() {
    ...
    key: "submit",
    value: async function submit(data) {
      if (data == null) {
